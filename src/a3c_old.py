    ...
    while True:
        ...
        for _ in range(num_local_steps):
            ...
            if predictor is not None:
                ...
                bonus = bonus + diff if diff <= 1 else 1
            ...
            if terminal or length >= timestep_limit:
                ...
                #df.to_csv('./real_test/run_as_is/1-2/20w/distance' + str(task) + '.csv', index=False)
                df.to_csv('./fine_tuned_model/1-3/20w/distance' + str(task) + '.csv', index=False)
                print('++++++++++++++++++++++++++')
    ...
    def process(self, sess):
        ...
        if batch.terminal:
            ...
            if fetched[-1] >= logDirCounter and self.task == 0:
                ...
                fromDirectory = "./tmp/bonus33_"
                toDirectory = "./fine_tuned_model/1-3/20w/bonus33_" + str(self.task) + "_" + str(logDirCounter) + ".bk/"
